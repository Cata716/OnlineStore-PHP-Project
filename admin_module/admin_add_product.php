...
if (isset($_POST['submit'])) {
    ...
    if ($nume == '' || $code == '' || $imagine == '' || $price == '' || $descriere == '' || $categorie == '') {
        ...
        try {
            ...
            $query = "INSERT INTO tbl_product (name, code, image, price, descriere, categorie) VALUES (?, ?, ?, ?, ?, ?)";
            $db->updateDB($query, [$nume, $code, $imagine, $price, $descriere, $categorie]);
...
<body>
    ...
    <form action="" method="post">
        <div>
            ...
            <a href="../magazin_module/index.php">Index Produse</a><br>
            <a href="admin_home">Home admin</a>
        </div>
    </form>
</body>
